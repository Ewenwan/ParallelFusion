...
We have validated our ideas on three problems in Computer Vision,
stereo, optical flow, and layered depthmap estimation. \yasu{add more
once we see results.}  Our approach is extremely simple in concept, and
will instantly benefit every Computer Vision researcher or engineer, who
currently uses fusion move algorithm to solve challenging problems. We
will share our implementation of the algorithm. The rest of the paper is
organized as follows. Section~\ref{section:related_work}....
