...
template <class LABELSPACE> using SolutionType = std::pair<double, LABELSPACE>;

// FusionSolver class represents both energy definition and solving procedure.
template <class LABELSPACE> class FusionSolver {
public:
  // take initial value, run optimization and store solution in 'solution',
  // return error
  virtual void solve(const LABELSPACE &proposals,
                     const SolutionType<LABELSPACE> &current_solution,
                     SolutionType<LABELSPACE> &solution) = 0;
