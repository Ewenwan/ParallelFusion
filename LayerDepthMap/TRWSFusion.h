...
class TRWSFusion : public ParallelFusion::FusionSolver<LayerLabelSpace>
{
 public:
  ...
  void solve(const LayerLabelSpace &proposal_label_space, const ParallelFusion::SolutionType<LayerLabelSpace> &current_solution, ParallelFusion::SolutionType<LayerLabelSpace> &solution);
  double evaluateEnergy(const LayerLabelSpace &solution) const { return 100000000; };
