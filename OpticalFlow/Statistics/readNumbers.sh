...
cat output_thread_1 | awk '{ print $5 "\t" $8 "\t" $7 }' > output_values_thread_1
cat output_thread_2 | awk '{ print $5 "\t" $8 "\t" $7 }' > output_values_thread_2
cat output_thread_8 | awk '{ print $5 "\t" $8 "\t" $7 }' > output_values_thread_8