#./OpticalFlow --num_threads=5 --num_iterations=100 --num_proposals_in_total=1 --num_proposals_from_others=0 --solution_exchange_interval=5 --use_monitor_thread=true --result_index=5
#./OpticalFlow --num_threads=5 --num_iterations=100 --num_proposals_in_total=1 --num_proposals_from_others=1 --solution_exchange_interval=5 --use_monitor_thread=true --result_index=6
#./OpticalFlow --num_threads=1 --num_iterations=100 --num_proposals_in_total=1 --num_proposals_from_others=0 --solution_exchange_interval=5 --use_monitor_thread=false --result_index=7
