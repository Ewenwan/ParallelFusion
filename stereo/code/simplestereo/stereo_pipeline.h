...
namespace simple_stereo {
    ...
    class StereoPipeline : public ParallelFusion::ParallelFusionPipeline<CompactLabelSpace> {
    public:
        StereoPipeline(const ParallelFusion::ParallelFusionOption &option) : ParallelFusionPipeline(option) { }

        virtual void monitorThread(const int id, GeneratorPtr generator, SolverPtr solver,
